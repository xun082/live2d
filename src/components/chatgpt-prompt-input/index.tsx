              ...
              <div className="flex items-center gap-2">
                <Tooltip>
                  ...
                  <TooltipTrigger asChild>
                    <button
                      ...
                      className="flex h-8 w-8 items-center justify-center rounded-full text-gray-600 dark:text-gray-300 transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-800 dark:hover:text-white focus-visible:outline-none hover:scale-105 active:scale-95"
                    >
                ...
                <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <PopoverTrigger asChild>
                        <button
                          type="button"
                          className="flex h-8 items-center gap-2 rounded-full px-3 text-sm text-gray-600 dark:text-gray-300 transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-800 dark:hover:text-white focus-visible:outline-none hover:scale-105 active:scale-95"
                        >
                  ...
                  <PopoverContent
                    side="top"
                    align="start"
                    className="rounded-xl bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-gray-200/60 dark:border-gray-700/60 p-2"
                  >
                    <div className="flex flex-col gap-1">
                      {toolsList.map((tool) => (
                        <button
                          ...
                          className="flex w-full items-center gap-3 rounded-lg p-3 text-left text-sm hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 dark:hover:from-blue-900/20 dark:hover:to-purple-900/20 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
                        >
                          <tool.icon className="h-4 w-4 text-gray-600 dark:text-gray-300" />
                          <span className="font-medium text-gray-800 dark:text-gray-200">
                            {tool.name}
                          </span>
                          {tool.extra && (
                            <span className="ml-auto text-xs px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full">
                              {tool.extra}
                            </span>
                          )}
                        </button>
